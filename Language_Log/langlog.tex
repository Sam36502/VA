...
\subsection{Saturday 11\textsuperscript{th} of December}
Here, and on the following Sunday, with the hand-in of the VA approaching, I really
shifted my A into G, to use a favourite expression of my parents, and got to work
finishing up whatever was left to do before the end of the project. That included
something I'd been putting off the whole time: creating the dictionary. I already had
a CSV table with all the generic definitions in it, but I had to go through and add
a definition for each form of the root, which was no small task. Over the course of
the weekend, my volunteers also slowly made their way through the text I'd given them
with my help in matters of grammar. As they worked on that, I also continued writing
texts for the final document I'd have to hand in.
