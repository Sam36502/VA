...
{\Large\textbf{p-x}} \\
\entry{pux}{"pux}{n. sg.}{Food, an item of food, a meal}
\entry{púx}{"p2x}{n. pl.}{Food, many items of food}
\entry{pyx}{"pix}{v. ind.}{to eat, to drink, to consume}
\entry{pýx}{"pyx}{v. imp.}{eat!, drink!, consume!}
\entry{pax}{"pax}{a. pos.}{edible}
\entry{páx}{"p\oe x}{a. sup.}{most edible}
...
{\Large\textbf{k-ñ}} \\
\entry{kuñ}{"kuN}{n. sg.}{a walk, a motion/movement, a journey}
\entry{kúñ}{"k2N}{n. pl.}{many walks, many motions/movements, many journeys}
...
\entry{káñ}{"k\oe N}{a. sup.}{moving the most, the most alive}
